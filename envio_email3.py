...
class mailTo:
    ...
    def __init__(self):
        ...
        self.email_senha = getpass.getpass(prompt='Senha: ', stream=None)
        

    def carregarModeloHTML(self):
        print("Carregando email_em_html.html....")
        file = codecs.open("email_em_html.html", "r", "utf-8")
        self.file = file
    ...
    def enviarEmail(self):
        ...
        arquivo =  open('lista_de_emails.txt','r') # Definição do arquivo que contem as listas de emails, Somente leitura
        ...
        for email_por_linha in arquivo:
            ...
            try:
                ...
                server = smtplib.SMTP("smtp.live.com",587) # Definido o servidor SMTP hotmail
